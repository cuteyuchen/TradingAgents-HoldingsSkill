...
export const api = {
  ...
  createManualProposal: (payload: { target_parameter_key: string; proposed_value: unknown; reason: string; proposal_type?: string; risk_acknowledged?: boolean; risk_summary?: Record<string, unknown> | null }) => request<ParameterChangeProposal>('/api/v3/governance/proposals/manual', { method: 'POST', body: payload }),
