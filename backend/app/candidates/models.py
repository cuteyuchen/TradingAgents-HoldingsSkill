...
class CandidateRun(Base):
    ...
    quote_snapshot_id: Mapped[str | None] = mapped_column(String(64), index=True)
    ...
    structural_candidate_count: Mapped[int] = mapped_column(Integer, default=0)
    quote_ready_count: Mapped[int] = mapped_column(Integer, default=0)
    bar_ready_count: Mapped[int] = mapped_column(Integer, default=0)
    quote_coverage: Mapped[float] = mapped_column(Float, default=0.0)
    bar_coverage: Mapped[float] = mapped_column(Float, default=0.0)
