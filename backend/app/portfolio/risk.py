    ...
    *,
    ...
    for item in snapshot.holdings:
        ...
        positions.append({
            ...
            "lot_size": master.lot_size if master is not None else None,
            "is_suspended": bool(_quote_value(quote, "is_suspended")) or bool(master.is_suspended if master is not None else False),
